...
const dataSourceOptions: DataSourceOptions = {
  ...
  entities: [UserAuth, Property, Address, UserCredibility, SavedProperty, PropertyRequirement, DropdownOptions, UserKyc, RepublishProperty, PropertyImages, PropertyEnquiry],
  synchronize: false , 
  logging: false, 
